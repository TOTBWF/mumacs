...
(use-package notmuch
  :preface
  (defun notmuch-disable-font-locking ()
    "Disable font-locking in `notmuch' related modes."
    (setq-local font-lock-ensure-function 'ignore)
    (font-lock-mode 0))
  :ensure t
  :commands notmuch
  :hook
  (notmuch-tree-mode-hook . notmuch-disable-font-locking)
  (notmuch-search-mode-hook . notmuch-disable-font-locking)
  :custom
...
;; (load "~/Documents/Projects/imap-idle-mode/imap-idle-mode.el")
